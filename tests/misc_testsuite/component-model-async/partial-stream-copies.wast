  ...
  (component $C
    ...
    (core module $CM
      ...
      (func $transform (export "transform") (param i32) (result i32)
        ...
        (if (i32.ne (i32.const 3) (global.get $outsw))
          (then unreachable))

        ;; start async read on $insr which will block
        (local.set $ret (call $stream.read (global.get $insr) (i32.const 12) (global.get $inbufp)))
  ...
  (component $D
    ...
    (core module $DM
      ...
      (func $run (export "run") (result i32)
        ...
        (i64.store (i32.const 0) (i64.const 0x0123456789abcdef))
        (local.set $ret (call $stream.write (local.get $insw) (i32.const 0) (i32.const 8)))
