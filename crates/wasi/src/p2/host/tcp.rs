...
use crate::p2::{SocketResult, WasiP2Impl, WasiP2View};
...
impl<T> tcp::Host for WasiP2Impl<T> where T: WasiP2View {}

impl<T> crate::p2::host::tcp::tcp::HostTcpSocket for WasiP2Impl<T>
where
    T: WasiP2View,
{
    async fn start_bind(
...
pub mod sync {
    ...
    impl<T> HostTcpSocket for WasiP2Impl<T>
    where
        T: WasiP2View,
    {
        fn start_bind(
