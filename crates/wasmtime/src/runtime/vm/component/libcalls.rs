...
#[cfg(feature = "component-model-async")]
unsafe fn future_new(instance: &mut ComponentInstance, ty: u32) -> Result<ResourcePair> {
...
#[cfg(feature = "component-model-async")]
unsafe fn stream_new(instance: &mut ComponentInstance, ty: u32) -> Result<ResourcePair> {
...
#[cfg(feature = "component-model-async")]
unsafe fn context_get(instance: &mut ComponentInstance, slot: u32) -> Result<u32> {
    store[instance.id()].context_get(slot)
}

#[cfg(feature = "component-model-async")]
unsafe fn context_set(instance: &mut ComponentInstance, slot: u32, val: u32) -> Result<()> {
